...
if pio_import is None:
    raise RuntimeError("PlatformIO Import helper is unavailable")
pio_import("env")
env = globals()["env"]
...
path = env_libdeps_dir(env, "lvgl", "src", "widgets", "lv_textarea.c")
...
for old, new, label in (
    ...
    (set_prefix_old, set_prefix_new, "password set preallocation guard"),
...
obj_class_path = env_libdeps_dir(env, "lvgl", "src", "core", "lv_obj_class.c")
...
label_path = env_libdeps_dir(env, "lvgl", "src", "widgets", "lv_label.c")
...
event_path = env_libdeps_dir(env, "lvgl", "src", "core", "lv_event.c")
...
group_path = env_libdeps_dir(env, "lvgl", "src", "core", "lv_group.c")
